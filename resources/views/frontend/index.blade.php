...
@section('main')
    ...
    <img class="dark" src="{{ asset('frontend/assets/img/icons/invision_light.png') }}" alt="Invision">
    </li>
    <li>
    <img class="light" src="{{ asset('frontend/assets/img/icons/invision_light.png') }}" alt="Photoshop">
